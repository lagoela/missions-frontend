    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8" style={{ backgroundColor: '#d6d0c4' }}>
      ...
      >
        <header className="flex flex-col items-center gap-2">
          <p className="font-serif text-xs tracking-[0.25em] uppercase text-[#3a3530]/60">Begin your journey</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-serif text-xs tracking-[0.2em] uppercase text-[#3a3530]/70">Email</label>
            <input
              type="email"
              value={email}
        ...
        <button
          ...
          className="font-serif text-xs tracking-[0.2em] uppercase text-[#3a3530]/40 hover:text-[#3a3530]/70 transition-colors duration-200 cursor-pointer self-center"
        >
          ← Back to login
        </button>
      </div>
